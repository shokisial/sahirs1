...
mysqli_query($conn,"INSERT INTO `borrow` (`employee_number`, `tin_number`, `date_borrow`, `ti_barrow`, `file_status`, `date_return`, `ti_return`, `emp_request`, `cmnt`,stj) VALUES ('20', '$tin_number', '$dat', '$tim', 'borrowed', '0', '0', 'Abid', '$trns_res','1')")or die(mysqli_error());
