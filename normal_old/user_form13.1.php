   ...
   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Ready File Record Marketing</div>
                            </div>
...
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Ready File issue to Record')")or die(mysqli_error());
mysqli_query($conn,"UPDATE `transtbl` SET `trns_stu`='Complete File Send to Record',dat='$dat',user='$session_id',trns_stj='8',trns_accounts='$trns_res' where tin_number = '$tin_number' and trns_stj='7'")or die(mysqli_error());
...
mysqli_query($conn,"update file set trade_name = '0',status='returned' ,stj='0', trade_name='0',st_ver='0',st_ndc='0' where tin_number = '$tin_number' ")or die(mysqli_error());
...
?>
 ...
 <?php  $from1=0;  
			...
			$user_query3 = mysqli_query($conn,"select * from staff where staff_id='0'")or die(mysqli_error());
    ...
    $from = "$from1";
    $to = "$from2";
    $subject = "Ready File Send to Record ";
    $message = "Status send";
    $headers = "From:" . $from;
    if(mail($to,$subject,$message, $headers)) {
     ...
     ?>
<script>
  window.location = "edit_user13.1.php"; 
</script>
<?php
}  
//Mail
