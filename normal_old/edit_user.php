                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							$query = mysqli_query($conn,"select * from file where trade_name='$session_id' and stj='0'")or die(mysqli_error());
						if($session_id==='0'){ $query = mysqli_query($conn,"select * from file where status='returned'")or die(mysqli_error()); }
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
													$user_query = mysqli_query($conn,"select * from file where trade_name='$session_id' and stj='0' ")or die(mysqli_error());
								if($session_id==='0' or $session_id==='1'){ $user_query = mysqli_query($conn,"select * from file where status='returned'")or die(mysqli_error());}
