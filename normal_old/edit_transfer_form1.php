                            ...
                            <div class="block-content collapse in">
								...
								<form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="control-group">
								          <b>  Upload Consumer Pictures Transfer Time </b>
...
mysqli_query($conn,"INSERT INTO `borrow` (`employee_number`, `tin_number`, `date_borrow`, `ti_barrow`, `file_status`, `date_return`, `ti_return`, `emp_request`, `cmnt`,stj) VALUES ('10', '$edit_emplnumber', '$dat', '$tim', 'borrowed', '0', '0', 'record', 'Pending Ready','1')")or die(mysqli_error());

mysqli_query($conn,"update file set trade_name = '10',status='borrowed' ,stj='4' where tin_number = '$edit_emplnumber' ")or die(mysqli_error());
