       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_transfer_form1.php'); ?>			
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
						...
						if($session_id==='7'){ $query = mysqli_query($conn,"select * from ndc where ndc_stj='3'")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
								if($session_id==='7'){ $user_query = mysqli_query($conn,"select * from ndc inner join file on ndc.tin_number=file.tin_number where ndc.ndc_stj='3'")or die(mysqli_error());}
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
									    ...
									    <td><?php echo $row['ndc_no'];?></td>
												<td width="40">
												<a href="edit_transfer1.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
