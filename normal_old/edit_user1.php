...
<?php $get_id = $_GET['id']; ?>
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
						...
						if($session_id==='7'){ $query = mysqli_query($conn,"select * from file where stj='0'")or die(mysqli_error()); }
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
													$user_query = mysqli_query($conn,"select * from file where trade_name='$session_id' ")or die(mysqli_error());
								if($session_id==='7'){ $user_query = mysqli_query($conn,"select * from file where stj='0'")or die(mysqli_error());}
            ...
            <?php if($session_id==='7' or $session_id==='1'){include('edit_user_form2.php'); } ?>
