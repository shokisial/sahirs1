            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
						...
						if($session_id==='7'){ $query = mysqli_query($conn,"select * from file where stj<'4'")or die(mysqli_error()); }
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
								if($session_id==='7'){ $user_query = mysqli_query($conn,"select * from ndc inner join file on ndc.tin_number=file.tin_number where ndc_stj<'4'")or die(mysqli_error());}
