       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_user_form3.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($conn,"select * from verification where ver_stj = '10' ")or die(mysqli_error());
					...
					//	if($session_id!=18){ $query = mysqli_query($conn,"select * from file")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
													$user_query = mysqli_query($conn,"SELECT * FROM `verification` JOIN file on file.tin_number=verification.tin_number where verification.ver_stj = '10' ")or die(mysqli_error());
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
												...
												<td width="40">
												<a href="edit_user3.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
            ...
            <?php if($session_id==='7' or $session_id==='12'){include('edit_user_form2.php'); } ?>
