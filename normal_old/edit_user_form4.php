...
mysqli_query($conn,"UPDATE `verification` SET `ver_acstu`='$empno',ver_acres='$cmnt', ver_stj='$vrstj', user='$session_id', ver_exp='$next_due_date' where tin_number = '$tin_number' and ver_stj='2'")or die(mysqli_error());
...
mysqli_query($conn,"update file set trade_name = '0',status='returned' ,stj='$std' where tin_number = '$tin_number' ")or die(mysqli_error());
