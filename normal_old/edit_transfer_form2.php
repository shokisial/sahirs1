                            ...
                            <div class="block-content collapse in">
                                ...
                                <input type="hidden" name="seller" value="<? echo $flnm; ?>">
                                       ...
                                       <?php  
                                        ...
                                        <input type="hidden" name="fname" value="<? echo $gdn . ' ' . $fathername; ?>" >  
                                       ...
                                       <input type="hidden" name="jadd" value="<? echo $jaddress; ?>" >  
                                        ...
                                        <?php echo  '  ' .  $jcnic;?>
                                         ...
                                         <input type="hidden" name="jcnic" value="<? echo $cnic; ?>" > 
                                    ...
                                    <div class="control-group">
                                        ...
                                        */ ?>
                                        ...
                                        <button type="submit" name="update1" class="btn btn-success" formaction="afdt/sellerafd.php" formtarget="_blank" title="Seller Under taking"><i class="icon-save icon-large"></i></button>
