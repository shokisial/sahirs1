...
<?php include('../session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('pendingreturn_sidebar.php'); ?>
                ...
                <div class="span8" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php
									$user_query = mysqli_query($conn,"select * from return_request where employee_number='$empno' and status='not_confirmed'")or die(mysqli_error());
									...
									?>
												...
												<td><a href="preturn1.php <?php echo '?id='.$myid ?>" name="return" class="btn btn-success" class="icon-large" >Cancel</a></td>
