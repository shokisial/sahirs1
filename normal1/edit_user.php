            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
						...
						if($session_id!=17){ $query = mysqli_query($conn,"select * from file where trade_name='$session_id' ")or die(mysqli_error()); }
                            ...
                            <div class="block-content collapse in">
								...
								if($session_id!=17){ $user_query = mysqli_query($conn,"select * from file where trade_name='$session_id'")or die(mysqli_error());}
