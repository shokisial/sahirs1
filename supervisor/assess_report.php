        ...
        <div class="container-fluid">
            <div class="row-fluid">
				 <ul class="nav nav-pills">
										...
										<li class="active"><a href="assess_report.php">ASSESMENT REPORT</a></li>
									</ul>
                            ...
                            <div class="block-content collapse in">
								...
								<form  method="get">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
										<?php
									$user_query = mysqli_query($conn,"select * from assesment ")or die(mysqli_error());
