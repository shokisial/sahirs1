							...
							<?php $edit_emplnumber=0; 
								...
								<form method="post" enctype="multipart/form-data">
                                       ...
                                       Joint Address = <?php echo ' ' .  $jadd?> <Br>                    
                                        ...
                                        <button type="submit" name="update1" class="btn btn-success" formaction="afdt/afdtransferor.php" formtarget="_blank" title="MOU Print"><i class="icon-save icon-large"></i></button>
...
$jcnic = $_POST['jcnic']; $jcntno = $_POST['jcntno'];
*/ 
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Open File Printing')")or die(mysqli_error()); echo 'Done' . $rnlno . $aplname;

mysqli_query($conn,"UPDATE `file` SET stj='3' where opn_reg='1' and stj='4' and tin_number='$edit_emplnumber'")or die(mysqli_error());  


echo 'Open File Alocation Sucessfully';
//} 
?>
 <script>
