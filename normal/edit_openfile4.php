       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_openfile_form4.php'); ?>		   			
				</div>
                <div class="span7" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($conn,"select * from file where stj='108' and opn_reg='1' ")or die(mysqli_error());
						...
						//	echo 'user'. $session_id;
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
								if($session_id==='21'){ $user_query = mysqli_query($conn,"select * from file where stj='108' and opn_reg='1'")or die(mysqli_error());}
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
										...
										<td><?php echo $row['jfile_name'] . ' '; ?></td>
												...
												<td width="40">
												<a href="edit_openfile4.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
