...
$jcnic = $_POST['jcnic']; $jcntno = $_POST['jcntno'];
*/ 
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Open File Madiha Khan Clear')")or die(mysqli_error()); echo 'Done' . $rnlno . $aplname;

mysqli_query($conn,"UPDATE `file` SET stj='110',trade_name='17' where opn_reg='1' and stj='109' and tin_number='$edit_emplnumber'")or die(mysqli_error());  


echo 'Open File Clear by Madiha Khan Sucessfully';
//} 
?>
 <script>
  window.location = "edit_openfile7.php"; 
</script>
<?php } ?> 
