       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_user_form5.1.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
					...
					//	if($session_id!=18){ $query = mysqli_query($conn,"select * from file")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
												...
												<td width="40">
												<a href="edit_user5.1.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
            ...
            <?php if($session_id==='7' or $session_id==='12' or $session_id==='16' or $session_id==='18'){include('edit_transfer2_form2.php'); } ?>
