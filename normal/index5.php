...
$productResult = $db_handle->runQuery("SELECT file.tin_number,old_no,file.plot_no,file.file_name,file.fathername,file.cnicno,file.address,file.city,file.`cnt_no`,file.`file_type`,file.`jfile_name`,file.`jfathername`,file.`jcnicno`,file.`jaddress`,file.`jcity`,file.`jcnt_no`,file.file_category,file.block,file.cat,file.fector FROM `file`");
...
<td><?php echo $productResult[$key]["old_no"]; ?></td> 
