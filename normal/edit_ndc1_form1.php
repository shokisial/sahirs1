...
<head>
 ...
 document.getElementById('div2').style.display='none';
  ...
  function showfield2(name){
    if(name=='Open')document.getElementById('div3').style.display="block";
 ...
 <body onload="hidefield(); hidefield1(); hidefield2(); ">  
   <div class="row-fluid">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
                                       ...
                                       <div class="control-group">
                                        ...
                                        <div class="control-group">
										 Joint City	
                                          <input type="text" name="jcty"  placeholder="Joint City" value="0" onfocus="this.value=''"  style="text-transform: uppercase" required> 
                                          </div>
                                     ...
                                     <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="dtype"  class="" onchange="showfield2(this.options[this.selectedIndex].value)"  required>
                                    ...
                                    <div id="div3">
                                     <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="sndat2"  class="" required>
                                                <?php  
...
$cty = $_POST['cty'];      $cty = strtoupper($cty);
$cnic = $_POST['cnic'];   
$cntno = $_POST['cntno'];
...
$jcty = $_POST['jcty'];      $jcty = strtoupper($jcty);
$jcnic = $_POST['jcnic'];
$jcntno = $_POST['jcntno'];
$jgdn=$_POST['jgdn'];

$dtype=$_POST['dtype'];
$sndat = $_POST['sndat2']; if($dtype==='Default'){$sndat=$snd_dat1; }
$per =$_POST['per'];
...
if($type==='Open' and $ex==='0'){
    echo $snd_dat . 'This Dealer is not Elgible Open NDC';
    exit();?>
    <script>
  window.location = "edit_ndc1.php"; 
</script>
...
$next_due_date20=0;
if($type==='Open'){
    $next_due_date20 = date('Y/m/d', strtotime("+90 days"));
echo $next_due_date20;
}
...
//,'$aplname','$cntno','$rnlno','$sndat','$session_id','$empno','1','$per','$urgrpt'
 mysqli_query($conn,"INSERT INTO `ndc`(`tin_number`, `ndc_dat`, alt_no, alt_dat,`buyername`,gdn, `fathername`, `address`,city, `cnic`, `cntno`, type , `jbuyername`,jgdn, `jfathername`, `jaddress`, jcity,`jcnic`, `jcntno`,`dealer`, `per`, `ndc_no`, `user`, `dat`, `ndc_stu`, `ndc_res`, `ndc_stj`, `ndc_rpt`,ndc_urgpic,ndc_waveoff,ndc_waveoffpic,ndc_expdat) 
                                 VALUES ('$tin_number','$empno','$altno','$altdat', '$bname','$gdn','$fname','$add','$cty','$cnic','$cntno', '$type', '$jbname','$jgdn','$jfname','$jadd','$jcty','$jcnic','$jcntno','$sndat','$per','$rnlno','$session_id','$empno','Pending','0','1','$ndcrpt','$filename','$wave' ,'$filename1','$next_due_date20')")or die(mysqli_error());
mysqli_query($conn,"update file set st_ndc = 'Pending' where tin_number = '$tin_number' ")or die(mysqli_error());

mysqli_query($conn,"update verification set ver_stj = '4',`ver_expdat_status`='0' where tin_number = '$tin_number' and ver_stj='3'")or die(mysqli_error());
