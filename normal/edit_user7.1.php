...
<?php $get_id = $_GET['id']; ?>
       <body>
        ...
        <div class="container-fluid">
                ...
                <div class="span7" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($conn,"select * from transtbl where trns_stj='1.1' ")or die(mysqli_error());
					...
					//	if($session_id!=18){ $query = mysqli_query($conn,"select * from file")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
													$user_query = mysqli_query($conn,"SELECT * FROM `transtbl` JOIN file on file.tin_number=transtbl.tin_number where trns_stj='1.1' order by trns_per desc")or die(mysqli_error());
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
									...
									<td><?php echo $row['trns_appno'];?></td>
											    <td><?php echo $row['trns_per'];?></td>
												<td width="40">
												<a href="edit_user7.1.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
            ...
            <?php if($session_id==='7' or $session_id==='12' or $session_id==='16' or $session_id==='18' or $session_id==='10'){include('edit_transfer2_form2.php'); } ?>
