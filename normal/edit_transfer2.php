       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_transfer_form2.php'); ?>			
                ...
                <div class="span7" id="">
                     <div class="row-fluid">
						...
						if($session_id==='7' or $session_id==='1'){ $query = mysqli_query($conn,"select * from file where stj<'4'")or die(mysqli_error()); }
					...
					//	if($session_id!=18){ $query = mysqli_query($conn,"select * from file")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
							?>
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i>  Transfer Set File List</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
								if($session_id==='7' or $session_id==='9' or $session_id==='20' or $session_id==='1'){ $user_query = mysqli_query($conn,"select * from ndc inner join file on ndc.tin_number=file.tin_number where ndc_stj<'4'")or die(mysqli_error());}
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
									    ...
									    <td><?php echo $row['type'];?></td>
												<td width="40">
												<a href="edit_transfer2.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
            ...
            <?php if($session_id==='7' or $session_id==='1'){include('edit_ndc_form2.php'); } ?>
