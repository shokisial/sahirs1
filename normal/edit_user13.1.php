                ...
                <div class="span7" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($conn,"select * from transtbl where trns_stj='7' ")or die(mysqli_error());
					...
					//	if($session_id!=18){ $query = mysqli_query($conn,"select * from file")or die(mysqli_error()); }
						...
						//	echo 'user'. $session_id;
							?>
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Marketing File List  </div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
													$user_query = mysqli_query($conn,"SELECT * FROM `transtbl` JOIN file on file.tin_number=transtbl.tin_number where trns_stj='7' order by trns_per desc")or die(mysqli_error());
							...
							//	if($session_id!=18){ $user_query = mysqli_query($conn,"select * from file")or die(mysqli_error());}
												...
												<td width="40">
												<a href="edit_user13.1.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
