...
$jcnic = $_POST['jcnic']; $jcntno = $_POST['jcntno'];
*/ 
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Open File Abid Clear')")or die(mysqli_error()); echo 'Done' . $rnlno . $aplname;

mysqli_query($conn,"UPDATE `file` SET stj='111', trade_name='20' where opn_reg='1' and stj='110' and tin_number='$edit_emplnumber'")or die(mysqli_error());  


echo 'Open File Clear by Abid Javed Sucessfully';
//} 
?>
 <script>
  window.location = "edit_openfile6.php"; 
</script>
<? } ?> 
