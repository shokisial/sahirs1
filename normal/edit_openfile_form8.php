...
$jcnic = $_POST['jcnic']; $jcntno = $_POST['jcntno'];
*/ 
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Open File Saddam Clear')")or die(mysqli_error()); echo 'Done' . $rnlno . $aplname;

mysqli_query($conn,"UPDATE `file` SET stj='0', trade_name='0' where opn_reg='1' and stj='111' and tin_number='$edit_emplnumber'")or die(mysqli_error());  


echo 'Open File Clear by Sadam Hussain Sucessfully';
//} 
?>
 <script>
  window.location = "edit_openfile8.php"; 
</script>
<? } ?> 
