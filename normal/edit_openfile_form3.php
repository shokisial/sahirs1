...
$jcnic = $_POST['jcnic']; $jcntno = $_POST['jcntno'];
*/ 
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Open File A/C Clear')")or die(mysqli_error()); echo 'Done' . $rnlno . $aplname;

mysqli_query($conn,"UPDATE `file` SET stj='108',trade_name='21' where opn_reg='1' and stj='107' and tin_number='$edit_emplnumber'")or die(mysqli_error());  


echo 'Open File A/C Clear Sucessfully';
//} 
?>
 <script>
  window.location = "edit_openfile3.php"; 
</script>
<?php } ?> 
