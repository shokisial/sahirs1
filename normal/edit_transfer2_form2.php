      ...
      <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h2> Transfer File Detail </h2></div>
                            </div>
    <div class="tableFixHead">
      <table>
       ...
       <form method="post">
                        ...
                        <?php $sno=1; $image1=0;
								$query = mysqli_query($conn,"SELECT * FROM `transtbl` JOIN file on file.tin_number=transtbl.tin_number ")or die(mysqli_error());
                                ...
                                <td><?php  echo $row['trns_dealer']; ?> </td>
                                <td><?php  echo $row['trns_stu']; ?> </td>
                                
                                <td><?php  echo $row['dat']; ?> </td>
                                <td><?php  echo $row['trns_rptno'];  $image=$row['trns_pic']; ?> 
