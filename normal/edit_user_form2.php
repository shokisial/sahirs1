      ...
      <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h2> Verification File Detail </h2></div>
                           </div>
    <div class="tableFixHead" >
      <table>
       ...
       <form method="post">
                        ...
                        <?php $sno=1;
								$query = mysqli_query($conn,"SELECT * FROM `verification` JOIN file on file.tin_number=verification.tin_number  order by verification.ver_per DESC")or die(mysqli_error());
                                ...
                                <td><?php  echo $row['ver_id']; ?> </td>
                                <td><?php  echo $row['snd_dat']; ?> </td>
                                <td><?php  echo $row['ver_stu'] ; ?> </td>
                                <td><?php  echo $row['ver_res']; ?> </td>
                                <td><?php  echo $row['ver_acstu'] ; ?> </td>
                                <td><?php  echo $row['ver_acres']; ?> </td>
