       ...
       <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_openfile_form1.php'); ?>		   			
				</div>
                <div class="span7" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($conn,"select * from file where opn_reg=1 and stj=104")or die(mysqli_error());
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php  $tnm=0;
								if($session_id==='7' or $session_id==='10' or $session_id==='8' or $session_id==='20' or $session_id==='1'){ $user_query = mysqli_query($conn,"select * from file where opn_reg=1 and stj=104")or die(mysqli_error());}
